...
public class SWorldGenSwampTree extends WorldGenSwampTree {
    ...
    public boolean generate(BlockChangeDelegate world, Random random, int i, int j, int k) {
        ...
        if (j >= 1 && j + l + 1 <= 256) { //128=>256
            ...
            if (!flag) {
                ...
                if ((i1 == Block.GRASS.id || i1 == Block.DIRT.id) && j < 256 - l - 1) { //128=>256
